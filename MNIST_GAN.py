...
def define_discriminator(in_shape=(28,28,1)):
	...
	#model.add(Dropout(0.4))
	model.add(Flatten())
	model.add(Dense(128, activation='relu', kernel_initializer='he_uniform', input_dim=in_shape))
...
def save_plot(examples, epoch, n=10):
	...
	pyplot.close()
def save_plot_for_visualizing(examples, epoch, n=5):
        for i in range(n * n):
                # define subplot
                pyplot.subplot(n, n, 1 + i)
                # turn off axis
